                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div data-swiper-parallax="500" class="mt-4">
                                        <a href="https://wa.me/917598607516?text=Hi, I want to join the 2026 Selection Batch. Please share the details." class="btn-main">Join Selection Batch <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div data-swiper-parallax="500" class="mt-4">
                                        <a href="https://wa.me/917598607516?text=Hi, I want to enroll for the TNPSC Group exams. Please guide me on the process." class="btn-main">Enroll Today <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8">
                                    ...
                                    <div data-swiper-parallax="500" class="mt-4">
                                        <a href="https://wa.me/917598607516?text=Hi, I'd like to talk to a mentor about my TNPSC 2026 preparation strategy." class="btn-main">Meet Our Faculty <i class="fas fa-chevron-right fa-icon"></i><span class="circle"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
