export const FreeResourcesPage = (page) => {
  const pages = {
    'free-pdfs': {
      ...
      color: '#ea3943',
      description: 'Download high-quality study materials, formula sheets, and revision notes — completely free.',
      items: [
        { date: 'New', title: 'TNPSC Group 1 - Complete General Studies PDF (2025 Edition)', tag: 'Group 1', tagColor: '#4302ae', size: '12 MB' },
        { date: 'New', title: 'Indian Polity - Constitution Key Articles Summary', tag: 'Polity', tagColor: '#fe4c1c', size: '4 MB' },
        { date: 'Popular', title: 'Tamil Nadu History - Complete Notes (Tamil Medium)', tag: 'History', tagColor: '#ea3943', size: '8 MB' },
        { date: 'Popular', title: 'Aptitude & Reasoning - Shortcut Formula Sheet', tag: 'Aptitude', tagColor: '#00befa', size: '2 MB' },
        { date: 'Updated', title: 'Indian Economy - Budget 2025 Special Notes', tag: 'Economy', tagColor: '#ff007a', size: '5 MB' },
    ...
    'free-pyq': {
      ...
      items: [
        { date: '2024', title: 'TNPSC Group 1 Prelims 2024 - Solved Paper with Key', tag: 'Group 1', tagColor: '#4302ae', size: '200 Qs' },
        { date: '2024', title: 'TNPSC Group 2 Prelims 2024 - Complete Solution', tag: 'Group 2', tagColor: '#fe4c1c', size: '200 Qs' },
        { date: '2023', title: 'TNPSC Group 4 & VAO 2023 - Answer Key & Analysis', tag: 'Group 4', tagColor: '#00befa', size: '150 Qs' },
        { date: '2023', title: 'Group 1 Mains 2023 - Model Answer Write-ups', tag: 'Group 1', tagColor: '#4302ae', size: 'Mains' },
        { date: '2022', title: 'TNPSC Group 2A 2022 - Solved with Shortcuts', tag: 'Group 2A', tagColor: '#ff007a', size: '200 Qs' },
