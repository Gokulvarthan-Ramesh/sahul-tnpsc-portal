export const DailyUpdatesPage = (page) => {
  const pages = {
    'daily-ca': {
      ...
      color: '#4302ae',
      description: 'Stay updated with TNPSC-focused current affairs curated daily by our expert mentors.',
      items: [
        { date: 'April 10, 2025', title: 'Tamil Nadu Budget 2025-26 Key Highlights', tag: 'State', tagColor: '#4302ae' },
        { date: 'April 9, 2025', title: 'Supreme Court Landmark Verdict on Reservation', tag: 'National', tagColor: '#fe4c1c' },
        { date: 'April 8, 2025', title: 'New Governor Appointed for Tamil Nadu', tag: 'State', tagColor: '#4302ae' },
        { date: 'April 7, 2025', title: 'India Signs Free Trade Agreement with EU', tag: 'International', tagColor: '#00befa' },
        { date: 'April 6, 2025', title: 'RBI Monetary Policy - Key Takeaways', tag: 'Economy', tagColor: '#ff007a' },
    ...
    'exam-notifications': {
      ...
      icon: 'fas fa-bell',
      color: '#fe4c1c',
      description: 'Never miss a TNPSC exam date, hall ticket release, or result announcement.',
      items: [
        { date: 'April 10, 2025', title: 'TNPSC Group 1 Prelims 2025 - Notification Released', tag: 'Group 1', tagColor: '#4302ae' },
        { date: 'April 8, 2025', title: 'Group 2A Interview Post - Hall Ticket Available', tag: 'Group 2A', tagColor: '#fe4c1c' },
        { date: 'April 5, 2025', title: 'TNPSC Group 4 - Result Published', tag: 'Group 4', tagColor: '#00befa' },
        { date: 'April 3, 2025', title: 'VAO Exam 2025 - Apply Before May 15', tag: 'VAO', tagColor: '#ff007a' },
        { date: 'April 1, 2025', title: 'Combined Engineering Services - Notification', tag: 'CES', tagColor: '#4302ae' },
